<div>
    <div class="rounded-md bg-gradient-to-r from-slate-800 hover:to-slate-800 to-slate-900 mb-4">
                    ...
                    @if($is_editing)
                        <form wire:submit.prevent="updateReply" class="mt-4">
                            <input 
                                ...
                                class="bg-slate-800 border-1 border-slate-900 rounded-md w-full p-3 text-white/90 text-sm"
