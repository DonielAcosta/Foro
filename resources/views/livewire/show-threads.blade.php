    ...
    <div class="w-64">
        ...
        <ul class="mb-2">
            @foreach ($categories as $category )
                <li>
                    <a href="#" wire:click.prevent="filterBycategoty('{{ $category->id }}')" class ="p-2 rounded-md flex bg-slate-800 items-center gap-2 text-white/60 hover:text-white font-semibold text-xs capitalize">
            ...
            @endforeach
            <li>
                <a href="#" wire:click.prevent="filterBycategoty('')" class ="p-2 rounded-md flex bg-slate-800 items-center gap-2 text-white/60 hover:text-white font-semibold text-xs ">
                    ...
                    <div class="w-full">
                        ...
                        <p class="flex items-center justify-between w-full text-xs">
                            ...
                            <span class="text-slate-700 flex items-center gap-1">
                                <svg data-slot="icon" class ="h-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                ...
                                |
                                <a href="{{ route('thread.edit',$thread) }}"class="hover:text-white">Editar</a>
                            </span>
                        </p>
                    </div>
                </div>
